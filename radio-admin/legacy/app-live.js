const API_BASE_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/songs';
const EVENTS_API_BASE_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/events';
const STATS_SUMMARY_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/stats/summary';
const PRODUCT_STATS_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/stats/products?limit=25';
const SONG_STATS_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/stats/songs?limit=100';
const UPLOAD_PRESIGN_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/uploads/presign';
const REFERRER_STATS_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/stats/referrers?limit=50';
const DEVICE_STATS_API_URL = 'https://je3zud66nb.execute-api.us-east-1.amazonaws.com/prod-v2/admin/stats/devices?limit=50';

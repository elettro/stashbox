(() => {
  ...
  function render() {
    ...
    app.innerHTML = `
      <header class="v2-header">
        <a class="v2-wordmark" href="/radio/">STASH<span>BOX</span></a>
      ...
      <section class="v2-player" data-player hidden>
        ...
        <header class="v2-player-header"><button class="v2-icon-button" data-close>${icon.back}</button><a class="v2-player-mark" href="/radio/">STASH<span>BOX</span></a></header>
        <div class="v2-player-content player-info">
          <div class="v2-player-labels"><span data-pgenre></span><b><i></i>Now Playing</b></div>
          <h2 data-ptitle></h2>
          <div class="meta v2-artist-row"><span class="v2-mini-avatar" data-avatar></span><a class="v2-artist-profile-anchor" data-artist-profile-link href="/radio/artist/" style="color:#fff!important;text-decoration:none!important"><strong data-partist style="color:#fff!important;text-decoration:none!important;border-bottom:0!important"></strong></a></div>
  ...
  function openSong(key, autoplay) {
    ...
    if (artistLink) {
      artistLink.href = `/radio/artist/?artist=${encodeURIComponent(slug(selected.artist))}`;

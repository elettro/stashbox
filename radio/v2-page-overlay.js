(() => {
  ...
  function loadPortraitArtworkReliability() {
    ...
    script.src = '/radio/v2-portrait-artwork-reliability.js?v=20260802-portrait-rule1';
    script.defer = true;
  ...
  function openArtist(node) {
    ...
    const url = new URL('/radio/artist/', ORIGIN);
  ...
  function openGenre(node) {
    ...
    const url = new URL('/radio/genre/', ORIGIN);

...
assert(main.includes("new URL('/radio/desktop/'"), 'Main V2 page must route desktop to the clean runtime.');
assert(main.includes("desktopruntime') === 'legacy'"), 'Desktop legacy escape hatch must remain explicit.');

const requiredDesktopScripts = [
  '/radio/v2-boot-guard.js',
  '/radio/v2-session-manager.js',
  '/radio/desktop/browser-audio-map.js',
  '/radio/desktop/desktop-audio-compat.js',
  '/radio/v2-recovery.js',
  '/radio/desktop/desktop-auth-persist.js',
  '/radio/desktop/desktop-vec2.js',
  '/radio/desktop/desktop-vec-safety.js',
  '/radio/desktop/desktop-audio-master.js',
  '/radio/desktop/desktop-health.js',
  '/radio/v2-spacebar-transport.js'
];

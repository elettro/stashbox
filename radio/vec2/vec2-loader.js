(() => {
  ...
  css.rel = 'stylesheet';
  css.href = '/radio/vec2/vec2-stage.css?v=20260817-core3';
  ...
  const loadBridge = () => {
    ...
    bridge.src = '/radio/vec2/vec2-cms-bridge.js?v=20260817-cms1';
    bridge.async = false;
  ...
  controller.src = '/radio/vec2/vec2-controller.js?v=20260817-core3';

(() => {
  ...
  const loadVisibilityRepair = () => {
    ...
    repair.src = '/radio/attempt2/v2-desktop-rescue-visibility-repair-20260817.js?v=20260817-desktopvideo1';
    repair.async = false;
  ...
  const loadDesktopVideoRuntime = () => {
    ...
    runtime.src = '/radio/attempt2/v2-desktop-video-runtime-20260816-153.js?v=20260817-visibilityrepair1';
    runtime.async = false;
  ...
  script.src = '/radio/attempt2/v2-vec-player-controller.js?v=20260806-desktop-only1';
  script.async = false;

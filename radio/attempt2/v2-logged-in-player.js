(() => {
  ...
  function injectPlayerUi() {
    ...
    if (header && !header.querySelector('.v2-li-player-head-actions')) {
      ...
      actions.innerHTML = `
        ...
        <a class="v2-li-player-profile" data-li-profile href="/radio/attempt2/profile/" aria-label="Open your profile">P</a>`;
  ...
  function viewArtist() {
    ...
    location.href = `/radio/attempt2/artist/?artist=${encodeURIComponent(key)}`;
  }

...
BASE_URL="${V2_DESKTOP_DEPLOY_URL:-https://stashbox.com/radio/attempt2/desktop/}"
SOURCE_HTML="${V2_DESKTOP_SOURCE_HTML:-radio/attempt2/desktop/index.html}"
ENGINE_FILE="${V2_DESKTOP_ENGINE_FILE:-radio/attempt2/desktop/desktop-vec2.js}"

...
| SR-BUG-0026 | Logged-in Likes do not populate Profile Favorites | Profile / Favorites / Like | High | PROD + DEV V2 Mobile + Desktop | Fixed, verification pending | 2026-08-24 | `cbf16b11`, `3aa815d7` |
...
- `SR-BUG-0026` - Logged-in Like actions now also write the authenticated `/radio/me/favorites` record in PROD and DEV. Profile Favorites already reads that account table and its existing song-row handoff opens the selected favorite in the main player. User verification is pending.

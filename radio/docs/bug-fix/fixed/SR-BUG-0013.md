...
The persistent desktop shell repair associated with SR-BUG-0012 restored the Log In / Account and Notifications controls after recovery replaces the direct children of `#v2App`. The user directed that this duplicate symptom record be closed as Fixed and Verified on 2026-08-19.

## Regression checks retained for reopening
...
Closed as Fixed and Verified by user direction on 2026-08-19. If either desktop shell control disappears again, reopen this record or SR-BUG-0012 and inspect shell ownership and recovery rendering before changing auth or notification backends.

...
Not recorded during the original repair. Historical backfill awaited inspection of ratio selection, asset metadata, fallback order, and responsive breakpoints.

## Fix

User confirmed on 2026-08-17 that the wide desktop artwork selection issue is fixed.
...
If the issue returns, inspect the desktop ratio-selection path and verify asset metadata. Test songs with full six-ratio sets and songs with partial sets. Confirm a deterministic wide-first fallback order.

## Notes

Backfilled on 2026-08-17 from the 2026-08-04 desktop artwork report. Marked fixed by user on 2026-08-17.